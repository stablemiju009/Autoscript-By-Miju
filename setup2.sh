...
REPO="https://raw.githubusercontent.com/stablemiju009/Autoscript-By-Miju/main/"
...
function pasang_ssl() {
    ...
    curl https://raw.githubusercontent.com/stablemiju009/Autoscript-By-Miju/main/acme.sh -o /root/.acme.sh/acme.sh
